...
def get_enhanced_main_keyboard():
    ...
    keyboard = ReplyKeyboardMarkup(
        keyboard=[
            ...
            [KeyboardButton(text="📤 Экспорт данных"), KeyboardButton(text="🔍 Расширенный поиск")],
            [KeyboardButton(text="💾 Создать резервную копию"), KeyboardButton(text="🗂 Управление файлами")],
